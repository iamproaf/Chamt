...
OWNER_ID = int(getenv("OWNER_ID", "5301800943"))
MONGO_URL = getenv("MONGO_URL", None)
SUPPORT_GRP = getenv("SUPPORT_GRP", "katil_support")
UPDATE_CHNL = getenv("UPDATE_CHNL", "katil_bots")
OWNER_USERNAME = getenv("OWNER_USERNAME", "katil_your_dad")
